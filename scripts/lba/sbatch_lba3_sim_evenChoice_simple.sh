...
# job name:
#SBATCH -J lba3_sim_evenChoice_simple

# priority
#SBATCH --account=carney-frankmj-condo

# output file
#SBATCH --output ../../slurm/slurm_lba3_sim_evenChoice_simple_%A_%a.out
...
python -u lba3_sim_evenChoice_simple.py --config_path $config_path \
