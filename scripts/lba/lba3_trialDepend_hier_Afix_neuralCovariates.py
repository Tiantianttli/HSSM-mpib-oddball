...
simple_LBA_model_hier_dependTrialType = hssm.HSSM(
    ...
    include=[
        {
            "name": "v0",
            "formula": "v0 ~ 1 + (dummyV0) + (1 + pupil + beta_insula|participant_id) ",
            "link": "identity",
        },
        {
            "name": "v1",
            "formula": "v1 ~ 1 + (dummyV1) + (1 + pupil + beta_insula|participant_id)",
            "link": "identity",
        },
        {
            "name": "v2",
            "formula": "v2 ~ 1 + (dummyV2) + (1 + pupil + beta_insula|participant_id)",
            "link": "identity",
        }],
