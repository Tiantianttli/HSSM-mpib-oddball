...
# job name:
#SBATCH -J lbaTrlDep_singleSub

# priority
#SBATCH --account=carney-frankmj-condo

# output file
#SBATCH --output ../../slurm/slurm_lbaTrlDep_singleSub_%A_%a.out
...
python -u run_lba_trialDepend_real_singleSub_array.py --identity $SLURM_ARRAY_TASK_ID \
