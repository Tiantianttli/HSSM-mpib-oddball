...
# job name:
#SBATCH -J ddmReal_neuralDR

# priority
#SBATCH --account=carney-frankmj-condo

# output file
#SBATCH --output ../../slurm/slurm_ddmReal_neuralDR_%A_%a.out
...
python -u ddm_real_aFix_dependsSwitch_drfitRate_NeuralCovariates_noOffset.py --config_path $config_path \
