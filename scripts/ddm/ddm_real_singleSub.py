...
def ddm_real_singleSub(subNum):
    ...
    pathlib.Path(basepath+'/models/ddm/sept24/numpyro/singleSub/'+str(subID)+'/').mkdir(parents=True, exist_ok=True)


    fileName = basepath + '/models/ddm/sept24/numpyro/singleSub/'+str(subID)+ '/inferenceData_ddm_simple_allFree'+str(subID)+'_.nc'
    data = inferenceData_ddm_simple_allFree
