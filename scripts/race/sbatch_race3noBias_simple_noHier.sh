...
# job name:
#SBATCH -J race3noBias_noHier_simple

# priority
#SBATCH --account=carney-frankmj-condo

# output file
#SBATCH --output ../../slurm/slurm_race3noBias_noHier_simple_%A_%a.out
...
python -u race3noBias_simple_noHier.py --config_path $config_path \
