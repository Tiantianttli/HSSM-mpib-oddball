...
# job name:
#SBATCH -J raceReal_singleSub

# priority
#SBATCH --account=carney-frankmj-condo

# output file
#SBATCH --output ../../slurm/slurm_raceReal_singleSub_%A_%a.out
...
python -u run_race_real_singleSub_array.py --identity $SLURM_ARRAY_TASK_ID \
