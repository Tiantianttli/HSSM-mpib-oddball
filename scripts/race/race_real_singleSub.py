...
def race_real_singleSub(subNum):
    ...
    pathlib.Path(basepath+'/models/race/sept24/numpyro/singleSub/'+str(subID)+'/').mkdir(parents=True, exist_ok=True)


    inferenceData_simple_race_model=simple_race_model.sample(
    ...
    fileName = basepath + '/models/race/sept24/numpyro/singleSub/'+str(subID)+ '/inferenceData_race_simple_allFree'+str(subID)+'.nc'
    data = inferenceData_simple_race_model
