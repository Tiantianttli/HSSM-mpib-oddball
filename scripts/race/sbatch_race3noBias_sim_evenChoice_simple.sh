...
# job name:
#SBATCH -J race3noBias_evenChoice_simple

# priority
#SBATCH --account=carney-frankmj-condo

# output file
#SBATCH --output ../../slurm/slurm_race3noBias_evenChoice_simple_%A_%a.out
...
python -u race3noBias_sim_evenChoice_simple.py --config_path $config_path \
