...
pathlib.Path(basepath+'/models/hssm/aug24/numpyro/').mkdir(parents=True, exist_ok=True)
...
simple_ddm_model_hier_aFixed_noPrior = hssm.HSSM(
...
inferenceData_simple_ddm_model_hier_aFixed_noPrior=simple_ddm_model_hier_aFixed_noPrior.sample(
...
data = inferenceData_simple_ddm_model_hier_aFixed_noPrior
