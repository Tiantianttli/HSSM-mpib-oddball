...
inferenceSimData_simple_ddm_model_hier_aFixed_noPrior=simple_ddm_model_hier_aFixed_noPrior.sample(
...
data = inferenceSimData_simple_ddm_model_hier_aFixed_noPrior
