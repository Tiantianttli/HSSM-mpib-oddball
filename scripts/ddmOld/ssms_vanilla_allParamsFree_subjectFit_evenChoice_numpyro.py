...
inferenceSimDataEvenChoice_simple_ddm_model_hier_all_noPrior=simple_ddm_model_hier_all_noPrior.sample(
...
fileName = basepath + '/models/hssm/aug24/numpyro/ssms/inferenceSimDataEvenChoice_simple_ddm_model_hier_all_noPrior.nc'
data = inferenceSimDataEvenChoice_simple_ddm_model_hier_all_noPrior
