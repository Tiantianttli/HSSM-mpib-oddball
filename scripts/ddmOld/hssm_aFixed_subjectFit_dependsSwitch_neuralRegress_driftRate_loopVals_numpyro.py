...
def hssm_aVals_func(aVal):
    ...
    pathlib.Path(basepath+'/models/hssm/aug24/numpyro/aVals/driftRate/').mkdir(parents=True, exist_ok=True)
    ...
    fileName = basepath + '/models/hssm/aug24/numpyro/aVals/driftRate/inferenceData_simple_ddm_model_hier_aFix_dependsSwitch_trialNeuReg_driftRate_'+str(aVal)+'.nc'
