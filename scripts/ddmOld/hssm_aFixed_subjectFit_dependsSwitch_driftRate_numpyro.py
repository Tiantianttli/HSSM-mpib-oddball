...
ddm_model_hier_aFix_dependsSwitch_trialNeuReg = hssm.HSSM(
    ...
    include=[
        {
            "name": "v",
            "formula": "v ~ 1 + (1|participant_id)+(switch_condition_num|participant_id)",
            "link": "identity",
        }
    ],    
)
...
fileName = basepath + '/models/hssm/aug24/numpyro/inferenceData_simple_ddm_model_hier_aFix_dependsSwitch_driftRate.nc'
