...
ddm_model_hier_aFix_dependsSwitch_trialNeuReg = hssm.HSSM(
    ...
    include=[
        {
            "name": "z",
            "formula": "z ~ 1 + (switch_condition_num|participant_id)+(pupil|participant_id)+(beta_insula|participant_id)",
            "link": "identity",
        }
    ],    
)
...
fileName = basepath + '/models/hssm/aug24/numpyro/ssms/inferenceSimData_simple_ddm_model_hier_aFix_dependsSwitch_trialNeuReg_dummyVar.nc'
