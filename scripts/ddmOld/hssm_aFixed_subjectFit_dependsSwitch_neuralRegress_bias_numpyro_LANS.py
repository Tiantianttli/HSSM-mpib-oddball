...
pathlib.Path(basepath+'/models/hssm/aug24/numpyro/LANS/').mkdir(parents=True, exist_ok=True)
...
fileName = basepath + '/models/hssm/aug24/numpyro/LANS/inferenceData_simple_ddm_model_hier_aFix_dependsSwitch_trialNeuReg_bias.nc'
