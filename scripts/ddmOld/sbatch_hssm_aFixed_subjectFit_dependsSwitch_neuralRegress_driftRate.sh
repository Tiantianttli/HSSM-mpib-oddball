...
# output file
#SBATCH --output ../slurm/slurm_hddmDRneur_%A_%a.out
...
data_gen_base_path=/users/afengler/data/proj_tt/oddballLearningMPIB/models
...
python -u hssm_aFixed_subjectFit_dependsSwitch_neuralRegress_driftRate.py --config_path $config_path \
