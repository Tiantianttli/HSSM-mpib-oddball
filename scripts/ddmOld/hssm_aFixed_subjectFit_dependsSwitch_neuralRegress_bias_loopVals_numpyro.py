...
def hssm_aVals_func(aVal):
    print('running through main function')
    ...
    pathlib.Path(basepath+'/models/hssm/aug24/numpyro/aVals/bias/').mkdir(parents=True, exist_ok=True)
    ...
    fileName = basepath + '/models/hssm/aug24/numpyro/aVals/bias/inferenceData_simple_ddm_model_hier_aFix_dependsSwitch_trialNeuReg_bias_'+str(aVal)+'.nc'
