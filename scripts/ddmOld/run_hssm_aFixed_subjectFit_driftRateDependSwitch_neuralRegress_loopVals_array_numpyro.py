...
import sys
import argparse
import hssm_aFixed_subjectFit_dependsSwitch_neuralRegress_driftRate_loopVals_numpyro
...
if __name__ == "__main__":
    ...
    my_saved_result = hssm_aFixed_subjectFit_dependsSwitch_neuralRegress_driftRate_loopVals_numpyro.hssm_aVals_func(aVal = aVal)
